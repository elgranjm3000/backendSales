...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if ($driver === 'mysql') {
            ...
            // Trigger AFTER INSERT para quote_items
            DB::unprepared('
            ...
            // Trigger AFTER UPDATE para quote_items
            DB::unprepared('
            ...
            // Trigger AFTER DELETE para quote_items
            DB::unprepared('
            ...
            // Procedimiento para actualizar totales de quotes
            DB::unprepared('
        ...
        // Para PostgreSQL, la lógica está en los Model Events de Laravel
        // (QuoteItem y Quote models)
    }
    ...
    public function down(): void
    {
        ...
        // Solo eliminar triggers si es MySQL
        if ($driver === 'mysql') {
            ...
            DB::unprepared('DROP FUNCTION IF EXISTS calculate_quote_item_totals');
        }
    }
};
